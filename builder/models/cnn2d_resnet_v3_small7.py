...
class CNN2D_RESNET_V3_SMALL7(nn.Module):
        def __init__(self, args, device):
                super(CNN2D_RESNET_V3_SMALL7, self).__init__()      
                self.args = args
                self.dropout = 0.1
                ...
                self.features1 = nn.Sequential(
                        conv2d_bn(1,  16, (1,51), (1,1), (0,25)), 
                        nn.MaxPool2d(kernel_size=(1,4), stride=(1,4)),
                        )

                features2 = []
                block = InvertedResidual
                features2.append(block(16, 16, 1, expand_ratio=4))
                features2.append(block(16, 32, 2, expand_ratio=4))
